...
try {
    ...
    if ($method === 'GET' && $path === '/driver/profile') {
        ...
        tg_json(array(
            ...
            'is_online' => false,
            'current_latitude' => 42.4304,
            'current_longitude' => 19.2594,
            'heading' => 0,
            'rating_average' => 4.9,
            'rating_count' => 128,
            'total_rides' => 420,
        ...
        tg_json(array(
            'data' => array(
                array(
                    ...
                    'driver_id' => 2,
                    'status' => 'completed',
                    'pickup_latitude' => 42.4410,
                    'pickup_longitude' => 19.2628,
                    'pickup_address' => 'Trg Republike, Podgorica',
                    'dropoff_latitude' => 42.2864,
                    'dropoff_longitude' => 18.8400,
                    'dropoff_address' => 'Budva Old Town',
                    'final_fare' => 35.5,
                    'payment_method' => 'cash',
                    'created_at' => tg_now(),
                ),
                array(
                    ...
                    'driver_id' => 2,
                    'status' => 'completed',
                    'pickup_latitude' => 42.4340,
                    'pickup_longitude' => 18.7064,
                    'pickup_address' => 'Porto Montenegro, Tivat',
                    'dropoff_latitude' => 42.4247,
                    'dropoff_longitude' => 18.7712,
                    'dropoff_address' => 'Kotor Old Town',
                    'final_fare' => 18.0,
        ...
        tg_json(array(
            'data' => array(
                array(
                    ...
                    'description' => 'Thanks for the smooth ride to Budva.',
                    'status' => 'resolved',
