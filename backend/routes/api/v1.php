...
use App\Http\Controllers\Api\V1\RideCommsController;
...
Route::prefix('v1')->group(function () {
    ...
    Route::middleware('auth:sanctum')->group(function () {
        ...
        Route::prefix('rides')->group(function () {
            ...
            Route::get('{ride}/receipt/html', [RideController::class, 'receiptHtml']);
            Route::get('{ride}/messages', [RideCommsController::class, 'index']);
            Route::post('{ride}/messages', [RideCommsController::class, 'store']);
            Route::post('{ride}/masked-call', [RideCommsController::class, 'maskedCall']);
