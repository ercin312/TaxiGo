...
class DriverHomeSubmitBid extends DriverHomeEvent {
  const DriverHomeSubmitBid(this.amount);
...
class DriverHomeDismissSuccess extends DriverHomeEvent {
  const DriverHomeDismissSuccess();
}
