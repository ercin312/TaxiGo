...
class LocalAdminStore {
  ...
  static const _key = 'taxigo_admin_local_v3';
  ...
  void _seed() {
    final now = DateTime.now();
    users = [
      _user(1, 'Marko Yolcu', '+38267000001', 'passenger'),
      _user(2, 'Ana Yolcu', '+38267000002', 'passenger'),
      _user(3, 'Nikola Podgorica', '+38268000001', 'driver'),
      _user(4, 'Luka Budva', '+38268000002', 'driver'),
      _user(5, 'Petar Kotor', '+38268000003', 'driver'),
      _user(6, 'Jelena Bar', '+38267000003', 'passenger'),
      _user(7, 'Ivan Tivat', '+38268000004', 'driver', active: false),
    ...
    rides = [
      _ride(
        ...
        fare: 12.5,
        pickup: 'Trg Republike, Podgorica',
        dropoff: 'Delta City, Podgorica',
      ),
      _ride(
        102,
        'TG-D4E5F6',
      ...
      _ride(
        ...
        fare: 85.0,
        pickup: 'Podgorica Airport (TGD)',
        dropoff: 'Budva Old Town',
      ),
      _ride(
        104,
        'TG-J0K1L2',
        ...
        fare: 11.0,
        pickup: 'Mall of Montenegro',
        dropoff: 'Trg Republike',
      ),
      _ride(
        105,
        'TG-M3N4O5',
        ...
        fare: 95.0,
        pickup: 'Tivat Airport (TIV)',
        dropoff: 'Porto Montenegro',
      ),
      _ride(
        106,
        'TG-P6Q7R8',
