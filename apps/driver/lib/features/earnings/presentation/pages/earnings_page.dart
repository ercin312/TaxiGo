...
class _EarningsPageState extends State<EarningsPage> {
  ...
  void initState() {
    super.initState();
    getIt<FeatureModulesService>().refresh(force: true).then((_) {
      if (mounted) setState(() {});
    });
  }
  ...
  Future<void> _showWithdrawDialog(
    ...
    final result = await getIt<WalletRepository>().requestWithdrawal(
      amount: amount,
          ...
          return RefreshIndicator(
            ...
            child: ListView(
              ...
              children: [
                ...
                if (getIt<FeatureModulesService>().withdrawals)
                  PrimaryButton(
